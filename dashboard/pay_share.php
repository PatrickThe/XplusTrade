...
$result_set=mysqli_query($conn,$query);
            while($row=mysqli_fetch_array($result_set)){
             $order_amount=$row['order_amount'];
              ...
              $status = $row['status'];
              $subsequent_amount=$row['subsequent_amount'];
              }
                      ...
                      <?php
                       ...
                       <div class="col-lg-4 col-sm-4">
                                  ...
                                  <p>
                                      <?php 
                                      $dec=$amount;
$sqi="select * from login_user where expected_bal>='1' and is_queud!='0' and user_id!='$user_id' order by is_queud asc limit 1";
                          ...
                          <div class="text-center invoice-btn">
                            ...
                            <form action="Controller/PaymentController.php" method="POST">
                             ...
                             <input type="hidden" name="buyer_id" value="<?php echo $pat1;?>">
                               ...
                               <input type="hidden" name="subsequent_amount" value="<?php echo $susq;?>">
                             <input type="hidden" name="account_bal" value="<?php echo $pat3+$amount;?>">
                              <input type="checkbox" id="terms_and_conditions" value="1" onclick="terms_changed(this)"> I confirm ihave Send money to <?php echo $pat, ":",$pat2?>
