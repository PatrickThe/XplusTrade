          ...
          <section class="wrapper site-min-height">
               ...
               <div class="row">
                  <div class="col-lg-12">
                      <!--breadcrumbs start -->
                      <ul class="breadcrumb">
                          <li><a href="manage_users.php"><i class="fa fa-home"></i>Manage Users</a></li>
                          <li><a href="admin_shares.php">Manage Shares</a></li>
                          <li><a href="recvoncile_shares.php">Reconcile Shares</a></li>
...
$sqi="select * from shares order by date_created desc";
                  ...
                  while ($row=mysqli_fetch_array($record,MYSQLI_BOTH))
                  {
                    ...
                    $cat2=$row['shares_limit'];
                    $grosstotal=$cat2-$cat1;
                    $total=$cat*$grosstotal;
                  }
echo $total;
?>           
